...
| E45 | A3 dump alias / WRT residual / parsed fields | enwik8 100 MB | no codec; fair same-byte lzma | n/a | n/a | 507 s + 22 s | **KILLED as A**: self-pipe lzma +1.9 KB; WRT leftover is 1-letter crumbs (95.3% cover); fair table columns +10 KB; infobox-by-key +3.5 KB. See `A3.md`. Next A is A1 (`A1_PATCH.md`) |
| E46 | A4 title-index wikilinks → page varint | enwik8 / enwik8.3m | no codec; whole-file zlib + span lzma | n/a | n/a | 67 s | **KILLED as A**: 14% resolve; 95% of resolved titles in-dic; whole zlib +25,266 vs +967,199 raw; span lzma +17,264; shuffle ≈ live. See `A4.md`. |
| E47 | A5 typed URL/markup/prose streams | enwik8 + 3 MB | zlib9/lzma6 vs mixed; shuffle control | n/a | n/a | 549 s + 119 s | **KILLED as A**: concat+RLE zlib **−911,027** on enwik8; extract-to-tail −8.6 KB zlib on 3 MB. See `A5.md`. |
